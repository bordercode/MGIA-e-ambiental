...
El supuesto de partida es que el productor busca minimizar una función objetivo: **la función de costos.** como veremos esta condición implica la **maximización** de los beneficios (*profits*).
...
La unidad productiva en su operación incurre en una serie de **costos** y mediante la integración de insumos genera un producto o servicio que ofrece al consumidor. 
...
+ Estime el índice de concentración de concesiones por $Km^{2}$, para los casos de Nuevo León y un estado de la republica mexicana de su elección.


La figura siguiente muestra un ejemplo de la ubicación de las concesiones para el caso Chihuahua. 
